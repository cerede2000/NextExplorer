...
| `CONFIG_DIR`             | `/config`                                  | Location for `app.db` (accounts, shares, settings) and `logos/`. The folder to back up.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `CACHE_DIR`              | `/cache`                                   | Location for thumbnails, sessions, `index.db` (the search index and folder sizes), and temporary data. Everything in it can be rebuilt, but the indexes take a pass over the volumes to do so: mount it persistently. |
