...
| Tag                         | Contains                                                                         |
| --------------------------- | -------------------------------------------------------------------------------- |
| `latest`, `3.9.0`           | Everything, including hardware video acceleration (VA-API) and RAW photo support |
| `latest-lean`, `3.9.0-lean` | The same application without VA-API or RAW — a considerably smaller image        |
...
`package.json` — `3.9.0`, `3.9.0-lean` — republished for as long as that
