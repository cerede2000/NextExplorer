...
| Tag                         | Contains                                                                         |
| --------------------------- | -------------------------------------------------------------------------------- |
| `latest`, `3.8.1`           | Everything, including hardware video acceleration (VA-API) and RAW photo support |
| `latest-lean`, `3.8.1-lean` | The same application without VA-API or RAW — a considerably smaller image        |
...
`package.json` — `3.8.1`, `3.8.1-lean` — republished for as long as that
