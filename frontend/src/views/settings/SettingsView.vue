          ...
          <section>
            <div class="flex gap-2 items-center mb-4">
              <button
                ...
                class="inline-flex items-center justify-center rounded-md p-1.5 text-neutral-500 hover:bg-neutral-100 hover:text-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-700/70 dark:hover:text-white"
                @click="closeSettings"
              >
            ...
            >
              ...
              >
                <component :is="c.icon" class="h-5 w-5 shrink-0" />
          ...
          <section v-if="isAdmin">
            ...
            >
              <button
                ...
                :key="c.key"
                type="button"
                class="flex min-w-40 items-center gap-2 rounded-lg border border-neutral-200/70 bg-white/80 px-3 py-2 text-left text-sm text-neutral-700 shadow-sm transition hover:bg-white dark:border-neutral-700/70 dark:bg-neutral-800/80 dark:text-neutral-200 dark:hover:bg-neutral-700/80 md:min-w-0 md:w-full"
                :class="
                  isActive(c.key)
                    ? 'border-blue-500/70 bg-blue-50/80 text-blue-700 dark:border-blue-400/70 dark:bg-blue-500/10 dark:text-blue-200'
                    : ''
