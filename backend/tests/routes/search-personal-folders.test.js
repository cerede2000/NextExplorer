 ...
 *
 * With the index, two files tell it apart from the storage: one it knows and
 * the disk no longer has, which only the index can name, and one written
 * after the pass, which only the storage can read.
 */
